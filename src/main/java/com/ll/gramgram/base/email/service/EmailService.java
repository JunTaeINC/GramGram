...
public class EmailService {
    ...
    public void sendEmail(Member member) {
        ...
        simpleMailMessage.setText(("""
                안녕하세요 'GramGram'입니다.
                회원가입을 축하드립니다! %s님! 'GramGram'에서는 다양한 서비스를 이용하실 수 있습니다.
                지금부터 'GramGram' 서비스를 자유롭게 이용하실 수 있습니다.
                추가적인 문의사항이 있으시면 언제든지 저희 'GramGram' 고객센터로 문의해주세요.""").formatted(member.getUsername()));
